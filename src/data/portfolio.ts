...
export const designTools = [
  ...
  },
  {
    ...
    category: "Motion",
    description: "Motion graphics, titles, and animated brand assets.",
    color: "#9999FF",
    img: "/tools/adobe-after-effects.png",
    icon: "Ae",
  },
  {
    name: "Adobe Premiere Pro",
    category: "Video",
    description: "Video editing for reels, promos, and campaigns.",
    color: "#EA77FF",
    img: "/tools/adobe-premiere-pro.png",
    icon: "Pr",
  },
  {
    name: "Canva",
